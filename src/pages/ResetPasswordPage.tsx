...
export default function ResetPasswordPage() {
  ...
  const inputStyle: React.CSSProperties = {
    width: '100%', padding: '12px 14px', paddingRight: 42,
  ...
  const EyeBtn = ({ show, toggle }: { show: boolean; toggle: () => void }) => (
    <button type="button" onClick={toggle} style={{
      ...
      background: 'none', border: 'none', color: '#555', cursor: 'pointer', padding: 0, lineHeight: 1,
    }}>
      {show ? (
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <img src={logoImg} alt="Etork Brasil" style={{
          ...
          {!ready && !done && (
            <div style={{ textAlign: 'center', padding: '16px 0' }}>
              <div style={{
                ...
                border: '2px solid #222', borderTop: '2px solid #c8c8c8',
                margin: '0 auto 16px',
              ...
              <p style={{ color: '#2e2e2e', fontSize: 11, marginTop: 10 }}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: 14 }}>
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    />
                    <EyeBtn show={showPassword} toggle={() => setShowPassword(s => !s)} />
                  </div>
                  ...
                  {password && (
                    <div style={{ marginTop: 8 }}>
                      ...
                      <span style={{ fontSize: 10, color: strengthColor, fontWeight: 600, letterSpacing: 0.5 }}>
                        {strengthLabel}
                      </span>
                    </div>
                  )}
                  ...
                  <div style={{ position: 'relative' }}>
                    <input
                      ...
                      style={{
                        ...inputStyle,
                        borderColor: confirm
                          ? confirm === password ? '#27ae60' : '#c0392b'
                          : '#1e1e1e',
                      }}
                      onFocus={e => e.currentTarget.style.borderColor = '#c8c8c8'}
                      onBlur={e => {
                ...
                {message.text && (
                  <div style={{
                    ...
                    fontSize: 12, lineHeight: 1.5, background: '#1e1e1e',
                    border: `1px solid ${message.type === 'error' ? '#c0392b55' : '#27ae6055'}`,
